...
contract MockStarlayIncentivesController is IStarlayIncentivesController {
  /*
   * @dev Returns the configuration of the distribution for a certain asset
   * @param asset The address of the reference asset of the distribution
   * @return The asset index, the emission per second and the last updated timestamp
   **/
  function getAssetData(address asset) external view override returns (uint256, uint256, uint256) {
    return (0, 0, 0);
  }
   ...
   * @return The asset index, the emission per second and the last updated timestamp
   **/
  function assets(address asset) external view override returns (uint128, uint128, uint256) {
    return (0, 0, 0);
  }
