...
contract UniswapRepayAdapter is BaseUniswapAdapter {
   ...
   * The user should give this contract allowance to pull the LTokens in order to withdraw the underlying asset, swap it
   ...
   * The user should give this contract allowance to pull the LTokens in order to withdraw the underlying asset
  ...
  function swapAndRepay(
    ...
    if (collateralAsset != debtAsset) {
      ...
      // Pull lTokens from user
      _pullLToken(
        collateralAsset,
        collateralReserveData.lTokenAddress,
        msg.sender,
        amounts[0],
        permitSignature
      );
