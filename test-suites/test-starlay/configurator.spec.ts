...
import { strategyWETH } from '../../markets/starlay/reservesConfigs';
...
makeSuite('LendingPoolConfigurator', (testEnv: TestEnv) => {
  ...
  it('Check the onlyStarlayAdmin on deactivateReserve ', async () => {
  ...
  it('Check the onlyStarlayAdmin on activateReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyStarlayAdmin on freezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyStarlayAdmin on unfreezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyStarlayAdmin on disableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyStarlayAdmin on enableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyStarlayAdmin on configureReserveAsCollateral ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
      configurator
  ...
  it('Check the onlyStarlayAdmin on disableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyStarlayAdmin on enableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
